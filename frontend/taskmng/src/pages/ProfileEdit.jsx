...
function ProfileEdit() {
  ...
  const clickHandler = async()=>{
    ...
    try {
      const response = await axios.post('https://tasmang-backend.kuchbhimingwal.com/user/userUpdate',updateObj,axiosConfig);
      try {
        const users = await axios.get('https://tasmang-backend.kuchbhimingwal.com/user/getUsers', axiosConfig)
        const user = await axios.get('https://tasmang-backend.kuchbhimingwal.com/user/getuser', axiosConfig)
